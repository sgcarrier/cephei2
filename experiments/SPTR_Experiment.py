...
class SPTR_Experiment(BasicExperiment):
    '''
    ...
    def setup(self):
        ...
        self.board.laser_threshold.set_voltage(0)
    ...
    def run(self, fast_freq, slow_freq, array, ref_tdc, target_spad, rch, holdoff):
        '''
        ...
        target_spad_tdc = target_spad // 4

        '''Activate the TDC we are interrested in'''
        self.board.asic_head_0.disable_all_tdc_but(array, [ref_tdc, target_spad_tdc])
        '''Activate the corresponding SPAD to the TDC'''
        self.board.asic_head_0.disable_all_quench_but(array, [target_spad])
        ...
        path = genPathName_TDC(boardName="CHARTIER",
                               ASICNum=4,
                               matrixNum=array,
                               TDCsActive=[ref_tdc, target_spad_tdc],
                               controlSource="PLL",
                               fastVal=fast_freq,
                               slowVal=slow_freq,
                               testType="CORR",
...
if __name__ == '__main__':
    ...
    loggingSetup("SPTR_Experiment", level=logging.DEBUG)
    ...
    parser.add_argument("ref_tdc", help="TDC address to keep active")
    ...
    ref_tdc = ast.literal_eval(args.ref_tdc)
    ...
    _logger.info("ref_tdc set to :" + str(ref_tdc))
    ...
    experiment = SPTR_Experiment(filename=filename,
