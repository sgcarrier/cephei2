...
class SPAD_NON_CORR_SINGLE_Experiment(BasicExperiment):
    ...
    def run(self, fast_freq, slow_freq, array, tdc_addr, spad_addr, rch, holdoff, time_driven_period):
        ...
        input("Please set HV and press enter")
        time.sleep(2)
        '''Start writing the receiving data to the file
           This function is blocking'''
        self.board.b.DMA.start_data_acquisition_HDF(4, self.filename, groupName, datasetPath, self.countLimit,
                                                    maxEmptyTimeout=-1,
    ...
    def cleanup(self):
        ...
        :return:
        '''
        input("Please remove HV and press enter")
        self.board.asic_head_0.reset()
...
if __name__ == '__main__':
    ...
    runner = ExperimentRunner(experiment=experiment,
                              variables={'fast_freq': fast_freq, 
                                         ...
                                         'rch': rch, 
                                         'holdoff': holdoff, 
                                         'time_driven_period': time_driven_period})
